let apiURL = "https://api.airtable.com/v0/appFPsXPONU6qg5LK/Barren?api_key=keybFX53WeqK0YLFM";
...
let popupImage = document.getElementById("images");
...
async function main(){
	...
	for(let i = 0; i < apiData.records.length; i++){
		...
		heading.addEventListener('click', ()=>{
			...
			popupImage.src = apiData.records[i].fields.CityImage;
			});
