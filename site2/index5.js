let apiURL = "https://api.airtable.com/v0/appWvLgmMlDAxGnt5/Table%201?api_key=keybFX53WeqK0YLFM";
...
async function main(){
	...
	for(let i = 0; i < apiData.records.length; i++){
		...
		popupHeader.innerHTML = rainAmount;})


		//Popup image
		heading.addEventListener('click', ()=>{ images();
		let measureImage = apiData.records[i].fields.Image;
		console.log(measureImage);
		popupBody.innerHTML = measureImage;})
